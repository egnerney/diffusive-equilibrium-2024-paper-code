pro read_in_plot_8_APO_lines_emission_out_from_tables_lower_res
...
Restore, 'Mymodelv1_3D_JRM33+con20_cartesian_irrcart_mapped_no_interp_2degree_phi_into_rhoIII_4.5_281x281x129.sav',/verbose
  ...
  openr,1,'ypts_total_8apolines_vary_x0_and_z0_emission_table_281x129_with_tsum.txt'
  ...
  openr,1,'ypts_8apolinesa_vary_x0_and_z0_emission_table_281x129x8_with_tsum.txt'
...
;write_csv,'ypts_total_8apolines_vary_x0_and_z0_emission_table_281x129.csv',ypts_total_vary_x0_and_z0

;write_csv,'ypts_8apolines_vary_x0_and_z0_emission_table_281x129_sp6716.csv',reform(ypts_vary_x0_and_z0(*,*,6))
;write_csv,'ypts_8apolines_vary_x0_and_z0_emission_table_281x129_sp6731.csv',reform(ypts_vary_x0_and_z0(*,*,7))


;write_csv,'x_281x129.csv',xgrid
;write_csv,'z_281x129.csv',zgrid
