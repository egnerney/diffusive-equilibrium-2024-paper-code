...
Pro UV_sim_citep_2_my_model_v1_diffeq_3D_cart_grid_given_emission_tables_new_way_all_lines_for_clipper_torus_intervals
...
for iii = 0, n_intervals - 1 do begin
  for jjj = 0, n_et_each_interval - 1 do begin
     print,'iii = ', iii, ' of 44'
