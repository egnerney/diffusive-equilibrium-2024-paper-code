pro Iono_and_magneto_diffeq_from_ceq_refs_highres_field_line_interp_include_feh_into4_highest_res_aligned_only_integral
...
species0.name= ['O+','O++','S+','S++','S+++','H+','Na+','O+(hot)','H+ Ionosphere','e- Ionosphere','eh-','e-']
...
species0.m=[16.d,16.d,32.d,32.d,32.d,1.d,23.d,16.d,1d,1d/1837.d,1d/1837.d,1d/1837.d]
species0.q=[1.d,2.d,1.d,2.d,3.d,1.d,1.d,1.d,1d,-1d,-1.d,-1.d]

;Define species' densities and temperature at the equator
species0.T=[79.3d,79.3d,79.3d,79.3d,79.3d,79.3d,94.1d,362.d,0.31d,0.31d,46.d,4.6d]
species0.n=[592.d,76.3d,163.d,538.d,90.7d,50.6d,97.2d,134.d,2d5,2d5,2200.d*0.001d,2200.d]
species0.A=[1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,5.0d,1d,1d,5.0d,1.0d]
...
species0[10].type='Aniso_Maxwellian'
...
n_out = replicate({densities,sp:0.0,s2p:0.0,s3p:0.0,op:0.0,oph:0.0,o2p:0.0,hp:0.0,nap:0.0,hpi:0.0,ei:0.0,eh:0.0,elec:0.0},$
nrfls*nphifls,npointsfieldline) ;
 
 T_out = replicate({Temps,sp:0.0,s2p:0.0,s3p:0.0,op:0.0,oph:0.0,o2p:0.0,hp:0.0,nap:0.0,hpi:0.0,ei:0.0,eh:0.0,elec:0.0},$
  nrfls*nphifls,npointsfieldline) ; 
...
idx_ionosph = 1380 ; top of ionosphere northern hemisphere at r=1RJ for aligned high res integral only between -70-70 0.01 lat_III run
...
Pos0i = [r_int_fl[idx_ionosph],lat_int_fl[idx_ionosph],phi_int_fl_wlong[idx_ionosph], B_int_fl[idx_ionosph]]
...
;     
;dens and temp at ref points for me at cent-eq, ionosphere for those 2 though
; ['O+','O++','S+','S++','S+++','H+','Na+','O+(hot)','H+ Ionosphere','e- Ionosphere','eh-','e-']
ti000 = interpol(ti0,r_00,r_fl_ceq)
species0.T=[ti000,ti000,ti000,ti000,ti000,interpol(thp0,r_00,r_fl_ceq),ti000,interpol(toph0,r_00,r_fl_ceq),0.31d,0.31d,interpol(teh0,r_00,r_fl_ceq),interpol(tec0,r_00,r_fl_ceq)] ; correspond to r_00[j]



species0.n=[interpol(nop0,r_00,r_fl_ceq),interpol(no2p0,r_00,r_fl_ceq),interpol(nsp0,r_00,r_fl_ceq),interpol(ns2p0,r_00,r_fl_ceq),interpol(ns3p0,r_00,r_fl_ceq),interpol(nhp0,r_00,r_fl_ceq),interpol(nnap0,r_00,r_fl_ceq),interpol(noph0,r_00,r_fl_ceq),2d5,2d5,interpol(neh0,r_00,r_fl_ceq),interpol(nec0,r_00,r_fl_ceq)] ; correspond to r_00[j]
...
; charge neutral...
 ;['O+','O++','S+','S++','S+++','H+','Na+','O+(hot)','H+ Ionosphere','e- Ionosphere','eh-','e-']
species0[nspec-1].n=$
  -total(species0[0:nspec-5].q*species0[0:nspec-5].n,/double)$ ; was -2 then -3  now -5 because not inclding hot e nc hot protons, or ionospheric values
  /species0[nspec-1].q
;species0[nspec-1].n=$
...
potdrop = -1.38d;-12.1d;-7.81d;-20d;-6.73d;-6.74;4.51d;100d;-17.99d;(species0[i].T*alog(0.1d/2d5) - species0[i].m*(U0i - U0))/species0[i].q;1d2;3d4 ; 30,000 volts from ionosphere to Io aligned case 10 Licia Ray Thesis 2010
; following her I'll put Ionosphere at 0 volts and Io at -30,000 Volts then total neutrality gives potential along the way. 
...
for i = 0,npoints - 1 do begin
  ...
  n_ions[*,i]=diff_eq_eddie_iono_and_magneto(Poss[0:2,i],Pos0[0:2],Bratio[i],Pos0i[0:2],potdrop,species0,$
...
n_out[j,*].hpi = reform( reform( n_ions[8,*]),1,npointsfieldline)
n_out[j,*].ei = reform( reform( n_ions[9,*]),1,npointsfieldline)
n_out[j,*].eh = reform( reform( n_ions[10,*]),1,npointsfieldline)
n_out[j,*].elec = reform( reform( n_ions[11,*]),1,npointsfieldline)
...
T_out[j,*].hpi = Replicate(0.31d,1,npointsfieldline)
T_out[j,*].ei = Replicate(0.31d,1,npointsfieldline)
...
;rho_out[j,k,*] = rho_int_fl
  ...
  n_out[j,*].op = Replicate(0.,1,npointsfieldline)
  n_out[j,*].o2p = Replicate(0.,1,npointsfieldline)
  n_out[j,*].sp =  Replicate(0.,1,npointsfieldline)
  n_out[j,*].s2p = Replicate(0.,1,npointsfieldline)
  n_out[j,*].s3p = Replicate(0.,1,npointsfieldline)
  n_out[j,*].hp =  Replicate(0.,1,npointsfieldline)
  n_out[j,*].nap = Replicate(0.,1,npointsfieldline)
  n_out[j,*].oph = Replicate(0.,1,npointsfieldline)
  n_out[j,*].eh = Replicate(0.,1,npointsfieldline)
  n_out[j,*].elec = Replicate(0.,1,npointsfieldline)
  
  n_out[j,*].hpi = Replicate(0.,1,npointsfieldline)
  n_out[j,*].ei = Replicate(0.,1,npointsfieldline)
  ...
  T_out[j,*].hpi =  Replicate(0.,1,npointsfieldline)
  T_out[j,*].ei =  Replicate(0.,1,npointsfieldline)
...
write_csv,'phi_volts_-70to70_601_3D_integral_only5.91fl_aligned_iono_and_magneto.txt',phis

write_csv,'nhpi_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].hpi)
write_csv,'nei_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].ei)


write_csv,'nsp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].sp)

write_csv,'ns2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].s2p)

write_csv,'ns3p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].s3p)

write_csv,'nop_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].op)

write_csv,'noph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].oph)

write_csv,'no2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].o2p)

write_csv,'nhp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].hp)

write_csv,'nnap_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].nap)

write_csv,'nelec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].elec)

write_csv,'neh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(n_out[j,*].eh)

write_csv,'Telec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].elec)

write_csv,'Tic_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].sp)

write_csv,'Toph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].oph)

write_csv,'Thp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].hp)

write_csv,'Teh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].eh)


write_csv,'Thpi_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].hpi)

write_csv,'Tei_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_iono_and_magneto.txt',reform(T_out[j,*].ei)
