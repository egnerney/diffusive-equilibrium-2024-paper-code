pro eddie_run_diffeq_from_ceq_refs_highres_field_line_interp_include_feh_into4_highest_res_aligned_only_integral_test_new_variable_temp_along_fl_idea
...
species0.T=[ti000,ti000,ti000,ti000,ti000,interpol(thp0,r_00,r_fl_ceq)/5d,ti000,interpol(toph0,r_00,r_fl_ceq)/5d,interpol(teh0,r_00,r_fl_ceq)/5d,interpol(tec0,r_00,r_fl_ceq)] ; correspond to r_00[j]
...
write_csv,'phi_volts_-70to70_601_3D_integral_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',phis
...
write_csv,'nsp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].sp)

write_csv,'ns2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].s2p)

write_csv,'ns3p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].s3p)

write_csv,'nop_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].op)

write_csv,'noph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].oph)

write_csv,'no2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].o2p)

write_csv,'nhp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].hp)

write_csv,'nnap_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].nap)

write_csv,'nelec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].elec)

write_csv,'neh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(n_out[j,*].eh)

write_csv,'Telec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(T_out[j,*].elec)

write_csv,'Tic_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(T_out[j,*].sp)

write_csv,'Toph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(T_out[j,*].oph)

write_csv,'Thp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(T_out[j,*].hp)

write_csv,'Teh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-70to70_601_3D_integral_including_feh_only5.91fl_aligned_anisohots_A=5_and_hp_par_temp_over5.txt',reform(T_out[j,*].eh)
