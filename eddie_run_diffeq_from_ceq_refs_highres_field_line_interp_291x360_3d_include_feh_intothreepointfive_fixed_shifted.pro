pro eddie_run_diffeq_from_ceq_refs_highres_field_line_interp_291x360_3D_include_feh_intothreepointfive_fixed_shifted
...
openr,1,'nop_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
nop0=dblarr(601) 
readf,1,nop0 
close,1

openr,1,'no2p_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
no2p0=dblarr(601)
readf,1,no2p0 
close,1


openr,1,'nsp_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
nsp0=dblarr(601)
readf,1,nsp0
close,1

openr,1,'ns2p_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
ns2p0=dblarr(601)
readf,1,ns2p0
close,1

openr,1,'ns3p_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
ns3p0=dblarr(601)
readf,1,ns3p0
close,1

openr,1,'nhp_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
nhp0=dblarr(601)
readf,1,nhp0
close,1

openr,1,'noph_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
noph0=dblarr(601)
readf,1,noph0
close,1


openr,1,'nnap_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
nnap0=dblarr(601)
readf,1,nnap0
close,1
...
openr,1,'nec_mymodel1_601pts_4-10_densgaussianinside5_temps1inside5_shifted.csv'
nec0=dblarr(601)
readf,1,nec0
close,1
...
;print,Pos0[0:2]
;p1=plot(Poss[1,*],n_ions[9,*],xtitle='$Lat_{III} (Degrees)',ytitle='$n_{ec}$ ($cm^{-3}$)')
;p2=plot(Poss[1,*],n_ions[9,*] - (n_ions[0,*] + 2d*n_ions[1,*] + n_ions[2,*] + 2d*n_ions[3,*] + 3d*n_ions[4,*] + n_ions[5,*] + n_ions[6,*] + n_ions[7,*]),xtitle='$Lat_{III} (Degrees)',ytitle='$n_{ec}$ -  $\Sigma n_{i}q_{i}$ ($cm^{-3}$)')

;p2=plot(Poss[1,*],(n_ions[9,*] - (n_ions[0,*] + 2d*n_ions[1,*] + n_ions[2,*] + 2d*n_ions[3,*] + 3d*n_ions[4,*] + n_ions[5,*] + n_ions[6,*] + n_ions[7,*]))/n_ions[9,*],xtitle='$Lat_{III} (Degrees)',ytitle='% off Neutrality deltan/n')
...
;j_finished_through = j
;if ((j mod 10000) eq 0) then save,x_out,y_out,z_out,n_out, T_out, j_finished_through,jmax, FILENAME = 'diffeqoutput_lat-30to30_291x360_3D_analytic_fixed_shifted_nerneyv1modelintorhoc=4.sav', /verbose
...
write_csv,'nsp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.sp

write_csv,'ns2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.s2p

write_csv,'ns3p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.s3p

write_csv,'nop_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.op

write_csv,'noph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.oph

write_csv,'no2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.o2p

write_csv,'nhp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.hp

write_csv,'nnap_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.nap

write_csv,'nelec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.elec

write_csv,'neh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',n_out.eh

write_csv,'Telec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',T_out.elec

write_csv,'Tic_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',T_out.sp

write_csv,'Toph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',T_out.oph

write_csv,'Thp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',T_out.hp

write_csv,'Teh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-30to30_0.1deginterps_outto20_291x360_3D_analytic_including_feh_fixed_shifted.txt',T_out.eh
