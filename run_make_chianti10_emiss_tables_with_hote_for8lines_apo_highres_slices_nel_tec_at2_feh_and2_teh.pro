...
pro run_make_chianti10_emiss_tables_with_hote_for8lines_apo_highres_slices_nel_tec_at2_feh_and2_teh
  ...
  ; compile the widget
  resolve_routine, 'make_chianti10_emiss_tables_with_hote_for8lines_apo_highres_slices_nel_tec_at2_feh_and2_teh'

  ; run the widget
 make_chianti10_emiss_tables_with_hote_for8lines_apo_highres_slices_nel_tec_at2_feh_and2_teh
