        ...
        if R[i] >5.7:
            ...
            if R[i] >5.5:
               ...
               # vale=interp1d(R,kappa_electrons)(5.8)
                #plvale
                kappa_electrons[i] = 300.#vale*((R[i]/5.8) **plvale )
                Te_O[i] = interp1d(R,Te_O)(R[i])
                kappa_O[i] = interp1d(R,kappa_O)(R[i])
                Te_S[i] = interp1d(R,Te_S)(R[i])
                kappa_S[i] = interp1d(R,kappa_S)(R[i])  
...
np.savetxt('Te_electrons_012_momentsequal_bimax_to_kappa.csv', Te_electrons, delimiter=',')
np.savetxt('kappa_electrons_012_momentsequal_bimax_to_kappa.csv', kappa_electrons, delimiter=',')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('kappa_temperatures_vs_radial_distance_012_momentsequal_bimax_to_kappa.png', dpi=300)
plt.show()
...
try:
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('kappa_values_vs_radial_distance_012_momentsequal_bimax_to_kappa.png', dpi=300)
    plt.show()
