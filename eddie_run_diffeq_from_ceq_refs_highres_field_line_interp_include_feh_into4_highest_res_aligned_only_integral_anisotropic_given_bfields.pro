pro eddie_run_diffeq_from_ceq_refs_highres_field_line_interp_include_feh_into4_highest_res_aligned_only_integral_anisotropic_given_Bfields
...
species0.A = replicate(5d,nspec);[1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d];replicate(5d,nspec);[1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d,1.0d]
species0.type = replicate('fried_egg',nspec)
;species0[7].type =  'Aniso_Maxwellian' ;replicate('kappa_mv_version_noneq',nspec)
...
openr,1,'kappa_values_vs_rho_c_from_steffl2004b_figure10_2x13_values.csv'
kappa_vals=dblarr(2, 13) 
readf,1,kappa_vals
close,1

kappa_vals[1,12] = 1.51d; putting above 1.5... was under for some reason from digitization

kapvalnew = dblarr(2,17)

kapvalnew[0,*] = Reform([4d,5d,6d,Reform(kappa_vals[0,*]),10d],1,17)
kapvalnew[1,*] = Reform([1.51d,1.51d,4.3531d,reform(kappa_vals[1,*]),1.51d],1,17)

kappa_vals = kapvalnew
...
Poss = [[r_int_fl],[lat_int_fl],[phi_int_fl_wlong],[B_int_fl]];,[Replicate(1.,n_elements(r_int_fl))]]
...
;kappa_vals[1,12]
kapval = interpol(reform(kappa_vals[1,*]),reform(kappa_vals[0,*]),r_fl_ceq)
if (kapval le 1.5d) then kapval = 1.51d
species0.kappa = replicate(kapval,nspec)
;print,kapval,r_fl_ceq

;write_csv,'kappa_vals_current.csv',interpol(reform(kappa_vals[1,*]),reform(kappa_vals[0,*]),r_00)
;stop
;;;
...
BRATIO = B_int_fl/B_fl_ceq ; B/B0 ;replicate(1.,npoints) ; just so it doesn't break for now bc using isotropic so this doesn't matter A=1 so B doesn't matter
;stop
...
;write_csv,'z_outlat-50to50_601_3D_integral.txt',z_out ; if this changes want new one
;write_csv,'x_outlat-50to50_601_3D_integral.txt',x_out
;write_csv,'y_outlat-50to50_601_3D_integral.txt',y_out

;write_csv,'Bz_outlat-50to50_601_3D_integral.txt',Bz_out
;write_csv,'Bx_outlat-50to50_601_3D_integral.txt',Bx_out
;write_csv,'By_outlat-50to50_601_3D_integral.txt',By_out

difflabels = 'fried_egg_with_hoto'


write_csv,'nelec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.elec



write_csv,'nsp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.sp

write_csv,'ns2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.s2p

write_csv,'ns3p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.s3p

write_csv,'nop_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.op

write_csv,'noph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.oph

write_csv,'no2p_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.o2p

write_csv,'nhp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.hp

write_csv,'nnap_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.nap

write_csv,'nelec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.elec

write_csv,'neh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',n_out.eh

write_csv,'Telec_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',T_out.elec

write_csv,'Tic_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',T_out.sp

write_csv,'Toph_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',T_out.oph

write_csv,'Thp_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',T_out.hp

write_csv,'Teh_out_mymodel1_diffeq_jrm33+Con2020_0fillslat-50to50_601_3D_integral_including_feh'+ difflabels +'.txt',T_out.eh
