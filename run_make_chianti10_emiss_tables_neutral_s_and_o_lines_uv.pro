...
pro run_make_CHIANTI10_emiss_tables_neutral_s_and_o_lines_UV
  ...
  ; compile the widget
  resolve_routine, 'make_CHIANTI10_emiss_tables_neutral_s_and_o_lines_UV'

  ; run the widget
 make_CHIANTI10_emiss_tables_neutral_s_and_o_lines_UV
