...
pro run_make_CHIANTI10_emiss_tables_with_hote_for8lines_apo
  ...
  ; compile the widget
  resolve_routine, 'make_CHIANTI10_emiss_tables_with_hote_for8lines_apo'

  ; run the widget
 make_CHIANTI10_emiss_tables_with_hote_for8lines_apo
