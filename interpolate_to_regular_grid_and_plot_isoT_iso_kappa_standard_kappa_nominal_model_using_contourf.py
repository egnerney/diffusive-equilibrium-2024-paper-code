...
def isnotfinite(arr):
    ...
    return res
# Load n_out
#n_out_loaded_isomax =np.load('final_new_nominal_model_n_out_nominal_model_4-10_isoT_A=1_max_all_nominal_model.npz') 
n_out_loaded_isomax =np.load('final_new_nominal_model_n_out_nominal_model_4-10_isoT_isokappa_A=1_standard_kappa_all_nominal_model.npz') 
n_out_isomax = {key: n_out_loaded_isomax[key] for key in n_out_loaded_isomax}
...
# final_new_nominal_model_T_out_nominal_model_4-10_isoT_A=1_max_all_nominal_model.npz
# final_new_nominal_model_T_out_nominal_model_4-10_anisoT_A=2_max_all_nominal_model.npz
# final_new_nominal_model_T_out_nominal_model_4-10_isoT_isokappa_A=1_standard_kappa_all_nominal_model.npz
# final_new_nominal_model_T_out_nominal_model_4-10_anisoT_isokappa_A=2_standard_kappa_all_nominal_model.npz
# final_new_nominal_model_T_out_nominal_model_4-10_isoT_isokappa_A=1_product_kappa_all_nominal_model.npz
# final_new_nominal_model_T_out_nominal_model_4-10_isoT_isokappa_A=1_fried_egg_all_nominal_model.npz



# Load n_out
n_out_loaded = np.load('final_new_nominal_model_n_out_nominal_model_4-10_isoT_isokappa_A=1_standard_kappa_all_nominal_model.npz')
...
# Load field data
field_data = np.load('final_new_nominal_model_field_data_nominal_model_4-10_isoT_isokappa_A=1_standard_kappa_all_nominal_model.npz')
...
minnec=1.
maxnec=n_out_isomax['elec'].max()

minnsp=0.1
maxnsp=n_out_isomax['sp'].max()

minns2p=0.1
maxns2p=n_out_isomax['s2p'].max()

minns3p=0.1
maxns3p=n_out_isomax['s3p'].max()

minnop=0.1
maxnop=n_out_isomax['op'].max()

minno2p=0.1
maxno2p=n_out_isomax['o2p'].max()

minnnap=0.1
maxnnap=n_out_isomax['nap'].max()

minnhp=0.5
maxnhp=n_out_isomax['hp'].max()
...
plt.savefig('new_caseC_final.pdf', bbox_inches='tight', pad_inches=0, dpi=600)
