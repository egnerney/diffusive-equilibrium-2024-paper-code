function kappa_MV_version_gtmin1eq_density, species, deltaU, Phi, Bratio
  ...
  n = species.n*((1.d + (((-species.m*deltaU + species.q*Phi)/(species.kappa*species.T)) > (-1) ))^(0.5d - species.kappa))
