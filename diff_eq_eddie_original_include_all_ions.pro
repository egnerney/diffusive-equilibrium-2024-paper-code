function diff_eq_eddie_original_include_all_ions,Pos_in,Pos0_in,Bratio,species0_in,phi,$
...
;if (torus_side) then begin
	...
	while (nq*nq2 GT 0d) do begin
		...
		for i=0,nspec-1 do n[i] = call_function( $
		  ...
		  nq_temp = species0.q*n ;[species0[0:nspec-3].q*n[0:nspec-3],species0[nspec-1].q*n[nspec-1]] ; removing hot electrons from this
		...
		for i=0,nspec-1 do n2[i] = call_function( $
                ...
                nq2_temp = species0.q*n2 ;[species0[0:nspec-3].q*n2[0:nspec-3],species0[nspec-1].q*n2[nspec-1]]   ; removing hot electrons from this
	...
	while (abs(nq/n[nspec-1]/species0[nspec-1].q) GT 1d-5) do begin
		...
		for i=0,nspec-1 do nm[i] = call_function( $
                   ...
                   nqm_temp = species0.q*nm ;[species0[0:nspec-3].q*nm[0:nspec-3],species0[nspec-1].q*nm[nspec-1]]; removing hot electrons from this
