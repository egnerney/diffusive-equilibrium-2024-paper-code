...
if __name__ == '__main__':
    ...
    np.savez_compressed('new_nominal_model_n_out_nominal_model_4-10_isoT_isokappa_product_kappa_all_nominal_model.npz', **n_out)

    # Save T_out (dictionary of species temperatures)
    np.savez_compressed('new_nominal_model_T_out_nominal_model_4-10_isoT_isokappa_product_kappa_all_nominal_model.npz', **T_out)

    # Save x_out, y_out, z_out, B_out (NumPy arrays)
    np.savez_compressed('new_nominal_model_field_data_nominal_model_4-10_isoT_isokappa_product_kappa_all_nominal_model.npz',
