...
Pro make_CHIANTI10_emiss_tables_with_hote_for8lines_apo_low_res
...
nel = [1d,100d,500d, 1000d,1500d,2000d,2500d,3000d,3500d,4000d,6000d,8000d,10000d]

;Tec = [0.1d*dindgen(9) + 0.1d, 0.5d*dindgen(17)+1d,dindgen(10)+10d,5d*dindgen(8) + 20d, 20d*dindgen(7) + 60d, 80d*dindgen(6) + 200d]
Tec = [0.1,0.5d,1d,2d,3d,4d,5d,6d,8d,10d]



feh = [0.0001d,0.001d,0.0025d,0.005d,0.01d,0.05d,0.1d]
Teh = [5d*dindgen(4) + 35d, 20d*dindgen(3) + 60d, 100d*dindgen(3) + 200d]
...
;,/NOIONREC,/NO_RREC
write_csv,'yptsi_3000-7000_Angstroms_vary_nec_tec_feh_teh_lookuptable_13x10x7x10x2503_CHIANTI10_1_noprotons_NOIONREC_NO_RREC_low_res.dat',yptsi_vary_nel_tec
...
yptsi_in_temp = reform(yptsi_in(0,0,0,0,species_want))
...
write_csv,'yptsi_8_APO_LINES_optical_vary_nec_tec_feh_teh_lookuptable_13x10x7x10x8_CHIANTI_10.1_low_res.dat',APO_emiss_table
