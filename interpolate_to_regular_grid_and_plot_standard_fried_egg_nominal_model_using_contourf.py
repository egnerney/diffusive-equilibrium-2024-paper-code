...
# Load n_out
n_out_loaded = np.load('new_nominal_model_n_out_nominal_model_4-10_aniso_fried_egg_all_nominal_model.npz')
n_out = {key: n_out_loaded[key] for key in n_out_loaded}

# Load T_out
T_out_loaded = np.load('new_nominal_model_T_out_nominal_model_4-10_aniso_fried_egg_all_nominal_model.npz')
T_out = {key: T_out_loaded[key] for key in T_out_loaded}

# Load field data
field_data = np.load('new_nominal_model_field_data_nominal_model_4-10_aniso_fried_egg_all_nominal_model.npz')
...
plt.savefig('caseF_final.png', dpi=600, bbox_inches='tight', pad_inches=0)
