...
Pro UV_sim_citep_2_my_model_v1_diffeq_3D_cart_grid_given_emission_tables_new_way_only_op_eightthritythree
 ...
 stop
  ...
  yptsi_in = yptsi_in_op_eightthirtythree
...
For i = 0, n_elements(xgrid)-1 do begin ; 
  For j = 0, n_elements(zgrid)-1 do begin ; 
    ...
    ypts=new_CITEP_2_given_n_s_and_tel_s_using_emission_tables_sum_eightthirtythree_op_line(s,n,Tel,fwhm,binsize,yptsi_in_2dto1d,nel2dto1d,tec2dto1d)
