...
pro run_make_CHIANTI10_emiss_tables_neutral_only6300_O
  ...
  ; compile the widget
  resolve_routine, 'make_CHIANTI10_emiss_tables_neutral_only6300_O'

  ; run the widget
 make_CHIANTI10_emiss_tables_neutral_only6300_O
