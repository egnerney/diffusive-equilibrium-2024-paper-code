...
if __name__ == '__main__':
    ...
    # Use default colors for different cases
    colors_cases = plt.rcParams['axes.prop_cycle'].by_key()['color']
    ...
    for case_idx, case_name in enumerate(case_names):
        ...
        # Plot flux_tube_content vs r_eq
        plt.plot(r_eq_array_sorted, flux_tube_content_array_sorted, label=case_labels[case_idx])
