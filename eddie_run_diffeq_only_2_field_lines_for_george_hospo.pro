pro eddie_run_diffeq_only_2_field_lines_for_george_hospo
...
openr,1,'int_aligned_x_jrm33+con20analytic_secondtimeforGeorge_single_field_line.csv'
x_fl=dblarr(1000 ) ;  1000 points along field line including nans...... and nfls field lines
readf,1,x_fl ;RJ
close,1


openr,1,'int_aligned_y_jrm33+con20analytic_secondtimeforGeorge_single_field_line.csv'
...
openr,1,'int_aligned_z_jrm33+con20analytic_secondtimeforGeorge_single_field_line.csv'
...
rho_out = dblarr(npointsfieldline)

z_out = dblarr(npointsfieldline)


x_out = dblarr(npointsfieldline)

y_out = dblarr(npointsfieldline)


Bz_out = dblarr(npointsfieldline)


Bx_out = dblarr(npointsfieldline)

By_out = dblarr(npointsfieldline)

B_out = dblarr(npointsfieldline)
...
;B_int_fl = replicate(n_elements(Rho_fl(idx_finite)));Sqrt(Bx_int_fl^2d + By_int_fl^2d + Bz_int_fl^2d)
...
Poss = [[r_int_fl],[lat_int_fl],[phi_int_fl_wlong],[Replicate(1.d,n_elements(r_int_fl))]]
...
BRATIO = replicate(1.d,npoints);B_int_fl/B_fl_ceq; replicate(1.,npoints) ; just so it doesn't break for now bc using isotropic so this doesn't matter A=1 so B doesn't matter
;stop
...
n_out.op = reform(reform( n_ions[0,*]),npointsfieldline)
n_out.o2p = reform(reform( n_ions[1,*]),npointsfieldline)
n_out.sp =  reform(reform(n_ions[2,*]),npointsfieldline)
n_out.s2p = reform(reform( n_ions[3,*]),npointsfieldline)
n_out.s3p = reform(reform( n_ions[4,*]),npointsfieldline)
n_out.hp =  reform(reform(n_ions[5,*]),npointsfieldline)
n_out.nap = reform(reform( n_ions[6,*]),npointsfieldline)
n_out.oph = reform(reform( n_ions[7,*]),npointsfieldline)
n_out.eh = reform( reform( n_ions[8,*]),npointsfieldline)
n_out.elec = reform( reform( n_ions[9,*]),npointsfieldline)

;;;!!!!! fix below!!!!!
T_out.elec = Replicate(reform(interpol(tec0,r_00,r_fl_ceq)),npointsfieldline)
T_out.eh = Replicate(reform(interpol(teh0,r_00,r_fl_ceq)),npointsfieldline)
T_out.sp = Replicate(reform(ti000),npointsfieldline)
T_out.oph = Replicate(reform(interpol(toph0,r_00,r_fl_ceq)),npointsfieldline)
T_out.hp = Replicate(reform(interpol(thp0,r_00,r_fl_ceq)),npointsfieldline)
...
;write_csv,'z_outlat-60to60_601_3D_integral_only5.91fl_aligned.txt',reform(z_out[j,*])
;write_csv,'x_outlat-60to60_601_3D_integral_only5.91fl_aligned.txt',reform(x_out[j,*])
;write_csv,'y_outlat-60to60_601_3D_integral_only5.91fl_aligned.txt',reform(y_out[j,*])


;-70_to_70_first_time_for_george_isotropic_max.txt

write_csv,'phi_volts_-70_to_70_second_time_for_george_isotropic_max.txt',phis

;write_csv,'Bz_outlat-60to60_601_3D_integral_only5.91fl_aligned.txt',reform(Bz_out[j,*])
;write_csv,'Bx_outlat-60to60_601_3D_integral_only5.91fl_aligned.txt',reform(Bx_out[j,*])
;write_csv,'By_outlat-60to60_601_3D_integral_only5.91fl_aligned.txt',reform(By_out[j,*])



write_csv,'nsp_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.sp)

write_csv,'ns2p_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.s2p)

write_csv,'ns3p_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.s3p)

write_csv,'nop_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.op)

write_csv,'noph_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.oph)

write_csv,'no2p_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.o2p)

write_csv,'nhp_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.hp)

write_csv,'nnap_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.nap)

write_csv,'nelec_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.elec)

write_csv,'neh_-70_to_70_second_time_for_george_isotropic_max.txt',reform(n_out.eh)

write_csv,'Telec_-70_to_70_second_time_for_george_isotropic_max.txt',reform(T_out.elec)

write_csv,'Tic_-70_to_70_second_time_for_george_isotropic_max.txt',reform(T_out.sp)

write_csv,'Toph_-70_to_70_second_time_for_george_isotropic_max.txt',reform(T_out.oph)

write_csv,'Thp_-70_to_70_second_time_for_george_isotropic_max.txt',reform(T_out.hp)

write_csv,'Teh_-70_to_70_second_time_for_george_isotropic_max.txt',reform(T_out.eh)


write_csv,'x_-70_to_70_second_time_for_george_isotropic_max.txt',x_int_fl
write_csv,'y_-70_to_70_second_time_for_george_isotropic_max.txt',y_int_fl
write_csv,'z_-70_to_70_second_time_for_george_isotropic_max.txt',z_int_fl
;write_csv,'Btot_-70_to_70_first_time_for_george_isotropic_max.txt',Sqrt(Bx_int_fl^2d + By_int_fl^2d + Bz_int_fl^2d)
