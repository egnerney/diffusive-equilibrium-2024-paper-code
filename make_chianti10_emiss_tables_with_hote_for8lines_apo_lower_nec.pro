...
Pro make_CHIANTI10_emiss_tables_with_hote_for8lines_apo_lower_nec
...
Teh = [45,300];[5d*dindgen(4) + 35d, 20d*dindgen(3) + 60d, 100d*dindgen(3) + 200d]
...
APO_emiss_table = dblarr(n_ne,  n_te, 8)
...
yptsi_in_temp = reform(yptsi_in(28,0,species_want))
...
write_csv,'yptsi_8_APO_LINES_optical_vary_nec_tec_lookuptable_66x58x8_CHIANTI_10.1.dat',APO_emiss_table
