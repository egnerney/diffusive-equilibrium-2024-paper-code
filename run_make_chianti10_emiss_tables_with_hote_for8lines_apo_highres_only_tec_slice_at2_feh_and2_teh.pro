...
pro run_make_CHIANTI10_emiss_tables_with_hote_for8lines_apo_highres_only_tec_slice_at2_feh_and2_teh
  ...
  ; compile the widget
  resolve_routine, 'make_CHIANTI10_emiss_tables_with_hote_for8lines_apo_highres_only_tec_slice_at2_feh_and2_teh'

  ; run the widget
 make_CHIANTI10_emiss_tables_with_hote_for8lines_apo_highres_only_tec_slice_at2_feh_and2_teh
