...
minnec=1.
maxnec=n_out_iso_max['elec'].max()

minnsp=0.1
maxnsp=n_out_iso_max['sp'].max()

minns2p=0.1
maxns2p=n_out_iso_max['s2p'].max()

minns3p=0.1
maxns3p=n_out_iso_max['s3p'].max()

minnop=0.1
maxnop=n_out_iso_max['op'].max()

minno2p=0.1
maxno2p=n_out_iso_max['o2p'].max()

minnnap=0.1
maxnnap=n_out_iso_max['nap'].max()
